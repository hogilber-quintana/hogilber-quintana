...
[![Profile views](https://komarev.com/ghpvc/?username=hogilber-quintana&style=flat-square&color=0f766e)](https://github.com/hogilber-quintana)
...
```mermaid
flowchart LR
    Strategy["Business and product strategy"] --> Architecture["Architecture direction"]
    Architecture --> Platforms["Cloud and platform capabilities"]
    Architecture --> Patterns["Reference patterns and standards"]
    Platforms --> Teams["Product engineering teams"]
    Patterns --> Teams
    Teams --> Delivery["Reliable delivery"]
    Delivery --> Signals["Production signals"]
